...
class UserAllAddressFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentUserAllAddressBinding.inflate(inflater,container,false)
        initClicks()
        initCoroutines()
    ...
    companion object {
         ...
         * @return A new instance of fragment UserAllAddressFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserAllAddressFragment().apply {
